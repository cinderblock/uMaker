...
FREERTOS_BLDDIR ?= $(BuildPath)FreeRTOS/
...
$(FREERTOS_PORTDEFS_FILE:$(SRCDIR)%=$(BuildPath)%.o): | $(FREERTOS_PORTMACRO_HEADER_FILE)
...
FREERTOS_DEPFILES = $(FREERTOS_OBJS:$(BuildPath)%=$(BLD_DEPDIR)%.d)
