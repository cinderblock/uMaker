...
NRF51_EXTDRIVERS_BLDDIR ?= $(Build_Path)nRF51/$(NRF51_EXTDRIVERS)/
...
NRF51_EXTDRIVERS_OUT ?= $(Build_LibPath)$(NRF51_EXTDRIVERS_AR)

NRF51_EXTDRIVERS_GCCFLAGS_FINAL ?= $(Build_Flags_GCC_Final) $(NRF51_EXTDRIVERS_GCCFLAGS_EXTRA)
...
NRF51_EXTDRIVERS_DEPFILES = $(NRF51_EXTDRIVERS_OBJS:$(Build_Path)%=$(Build_DepPath)%.d)
