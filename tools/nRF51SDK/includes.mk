...
ifneq (,$(filter-out blank,$(NRF51_SOFTDEVICE_VERSION)))
 NRF51_HEADER_FILES_FILTER_OTHER ?= $(NRF51_SRCDIR)drivers_nrf/nrf_soc_nosd/
endif
...
NRF51_HEADER_FILES_FULL ?= $(filter-out $(NRF51_HEADER_FILES_FILTER)%,$(foreach file,$(NRF51_HEADER_FILES),$(shell find $(NRF51_SRCDIR) -type f -name "$(file)")))
