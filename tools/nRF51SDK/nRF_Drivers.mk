...
NRF51_NRFDRIVERS_OUT ?= $(Build_LibPath)$(NRF51_NRFDRIVERS_AR)

NRF51_NRFDRIVERS_GCCFLAGS_FINAL ?= $(Build_Flags_GCC_Final) $(NRF51_NRFDRIVERS_GCCFLAGS_EXTRA)
...
NRF51_NRFDRIVERS_DEPFILES = $(NRF51_NRFDRIVERS_OBJS:$(Build_Path)%=$(Build_DepPath)%.d)
