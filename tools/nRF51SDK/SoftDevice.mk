...
NRF51_SOFTDEVICE_BLDDIR ?= $(Build_Path)nRF51/$(NRF51_SOFTDEVICE)/
...
NRF51_SOFTDEVICE_OUT ?= $(Build_LibPath)$(NRF51_SOFTDEVICE_AR)

#NRF51_SOFTDEVICE_D_FLAGS ?= $(NRF51_SOFTDEVICE_DEFINES:%=-D%)

NRF51_SOFTDEVICE_GCCFLAGS_EXTRA ?= $(NRF51_SOFTDEVICE_D_FLAGS)

NRF51_SOFTDEVICE_GCCFLAGS_FINAL ?= $(Build_Flags_GCC_Final) $(NRF51_SOFTDEVICE_GCCFLAGS_EXTRA)
...
NRF51_SOFTDEVICE_DEPFILES = $(NRF51_SOFTDEVICE_OBJS:$(Build_Path)%=$(Build_DepPath)%.d)
