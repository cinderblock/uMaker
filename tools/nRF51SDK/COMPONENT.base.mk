...
NRF51_COMPONENT_BLDDIR ?= $(Build_Path)nRF51/$(NRF51_COMPONENT)/
...
NRF51_COMPONENT_OUT ?= $(Build_LibPath)$(NRF51_COMPONENT_AR)

NRF51_COMPONENT_GCCFLAGS_FINAL ?= $(Build_Flags_GCC_Final) $(NRF51_COMPONENT_GCCFLAGS_EXTRA)
...
NRF51_COMPONENT_DEPFILES = $(NRF51_COMPONENT_OBJS:$(Build_Path)%=$(Build_DepPath)%.d)
